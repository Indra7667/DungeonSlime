...
namespace CommonLib.Graphics;

public class TextureRegion
{
    // attributes
    /// <summary>
    /// get or set the source texture 
    /// of this region
    /// </summary>
    public Texture2D Texture { get; set; }

    /// <summary>
    /// get or set the rectangle boundary 
    /// of this region
    /// within the source
    /// </summary>
    ...
    /// <summary>
    /// create new filled instance 
    /// of this class
    /// using specified source texture2D
    /// </summary>
    /// <param name="texture">texture2d as source of this texture region</param>
    /// <param name="x">x coord position of the upper left corner of this texture region</param>
    /// <param name="y">y coord poition of the upper left corner of this texture region</param>
